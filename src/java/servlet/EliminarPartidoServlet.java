 ...
 * @author JuanG
 */
@WebServlet(name = "EliminarPartidoServlet", urlPatterns = {"/EliminarPartidoServlet"})
public class EliminarPartidoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            String borrarIdPartido = request.getParameter("idPartido");
            int idPartido = Integer.parseInt(borrarIdPartido);
            GestorBaseDatos g = new GestorBaseDatos();
            g.eliminarPartido(idPartido);
