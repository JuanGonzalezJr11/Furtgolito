 ...
 * @author JuanG
 */
@WebServlet(name = "QuitarSuspensionJugadorServlet", urlPatterns = {"/QuitarSuspensionJugadorServlet"})
public class QuitarSuspensionJugadorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            g.jugadorSuspendido(idJugador, 1);
