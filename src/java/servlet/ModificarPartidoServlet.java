 ...
 * @author JuanG
 */
@WebServlet(name = "ModificarPartidoServlet", urlPatterns = {"/ModificarPartidoServlet"})
public class ModificarPartidoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ModificarPartidoServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ModificarPartidoServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String modificarIdPartido = (String) request.getParameter("idPartido");
        int idPartido = Integer.parseInt(modificarIdPartido);
        Partido p = new Partido();
        p = g.obtenerPartidoPorId(idPartido);
        request.setAttribute("partido", p);
        RequestDispatcher rd = getServletContext().getRequestDispatcher("/ModificarPartido.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int jornada = Integer.parseInt((String) request.getParameter("txtJornada"));
        g.modificarPartido(new Partido(idPartido, fecha, hora, equipoLocal, equipoVisitante, arbitro, campo, jornada));
