...
public class ModificarUsuarioServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String modificarIdUsuario = (String) request.getParameter("idUsuario");
        int idUsuario = Integer.parseInt(modificarIdUsuario);
        Usuario u = new Usuario();
        u = g.obtenerUsuarioPorId(idUsuario);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        GestorBaseDatos g = new GestorBaseDatos();
        int idUsuario = Integer.parseInt((String) request.getParameter("txtIdUsuario"));
        String usuario = request.getParameter("txtUsuario");
        String contrasena = request.getParameter("txtContrasena");
        g.modificarUsuario(new Usuario(idUsuario, usuario, contrasena));
