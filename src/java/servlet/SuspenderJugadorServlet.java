 ...
 * @author JuanG
 */
@WebServlet(name = "SuspenderJugadorServlet", urlPatterns = {"/SuspenderJugadorServlet"})
public class SuspenderJugadorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            g.jugadorSuspendido(idJugador, 2);
